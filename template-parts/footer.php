        ...
        <div class="card-footer row m-0">
            ...
            <div>
                <p> <small class="follow-text">FOLLOW US ON SOCIAL MEDIA</small> <label class="footer-right">
                        <img src="assets/svg/icon-facebook.svg" height="16" width="16" alt="icon facebook"/>
                        <img src="assets/svg/icon-insta.svg" height="16" width="16" alt="icon insta"/>
                        <img src="assets/svg/icon-linkedin.svg" height="16" width="16" alt="icon linkedin"/>
            </div>
        </div>
    </div>
</div>
