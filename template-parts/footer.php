            ...
            <div class="row m-0 pt-5">
                ...
                <div class="card col-12 col-md-3">
                    <div class="card-content"> <i class="far fa-handshake fa-3x"></i>
                        <img src="assets/svg/icon%20facebook.svg" height="1000re6" width="16" alt="icon facebook"/>
                        <img src="assets/svg/icon%20insta.svg" height="16" width="16" alt="icon insta"/>
                        <img src="assets/svg/icon%20linkedin.svg" height="16" width="16" alt="icon linkedin"/>
                    </div>
                </div>
                <div class="card col-12 col-md-3">
